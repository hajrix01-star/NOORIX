export const PERMISSIONS = {
  ...
  VIEW_ORDERS_V3: 'VIEW_ORDERS_V3',
  ORDERS_V3_READ: 'ORDERS_V3_READ',
  ORDERS_V3_WRITE: 'ORDERS_V3_WRITE',
  ORDERS_V3_DELETE: 'ORDERS_V3_DELETE',
  ORDERS_V3_STAFF_SUBMIT: 'ORDERS_V3_STAFF_SUBMIT',
  ORDERS_V3_INTERNAL_SUBMIT: 'ORDERS_V3_INTERNAL_SUBMIT',
  ORDERS_V3_REPORTS_READ: 'ORDERS_V3_REPORTS_READ',
  ORDERS_V3_INVENTORY_WRITE: 'ORDERS_V3_INVENTORY_WRITE',

  VIEW_ORDERS_V4: 'VIEW_ORDERS_V4',
  ORDERS_V4_READ: 'ORDERS_V4_READ',
  ORDERS_V4_WRITE: 'ORDERS_V4_WRITE',
  ORDERS_V4_DELETE: 'ORDERS_V4_DELETE',
  ORDERS_V4_STAFF_SUBMIT: 'ORDERS_V4_STAFF_SUBMIT',
  ORDERS_V4_INTERNAL_SUBMIT: 'ORDERS_V4_INTERNAL_SUBMIT',
  ORDERS_V4_CASHIER_RECEIVE: 'ORDERS_V4_CASHIER_RECEIVE',
  ORDERS_V4_REPORTS_READ: 'ORDERS_V4_REPORTS_READ',
  ORDERS_V4_INVENTORY_WRITE: 'ORDERS_V4_INVENTORY_WRITE',
  ...
  ORDERS_STAFF_SUBMIT: 'ORDERS_STAFF_SUBMIT',
} as const;
