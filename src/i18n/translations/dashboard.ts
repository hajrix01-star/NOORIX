...
export default {
  ...
  dashboardFixedExpensesTitle: { ar: 'المصاريف الثابتة', en: 'Fixed expenses' },
  dashboardFixedExpensesDesc: { ar: 'إجمالي المصاريف الثابتة ونسبتها من مبيعات الفترة.', en: 'Fixed expenses and their share of period sales.' },
  dashboardPeriodAmount: { ar: 'مبلغ الفترة', en: 'Period amount' },
  dashboardShareOfSales: { ar: 'نسبة من المبيعات', en: 'Share of sales' },
  dashboardFixedExpenseInvoices: { ar: 'عدد فواتير المصروف الثابت', en: 'Fixed-expense invoices' },
  ...
  dashboardNoFixedExpenseDetails: { ar: 'لا توجد فواتير مصروف ثابت في الفترة المحددة.', en: 'No fixed-expense invoices in the selected period.' },
  dashboardFixedExpenseDetailsLimited: { ar: 'تظهر أحدث 100 فاتورة فقط حفاظًا على سرعة لوحة التحكم.', en: 'Only the latest 100 invoices are shown to keep the dashboard fast.' },
