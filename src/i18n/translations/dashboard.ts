...
export default {
  ...
  dashboardAnalytics: { ar: 'التحليلات', en: 'Analytics' },
  dashboardAnalyticsShort: { ar: 'تحليلات', en: 'Analytics' },
  dashboardVaultActivityTitle: { ar: 'الداخل وحركة الخزائن', en: 'Vault inflow and activity' },
  dashboardVaultActivityDesc: { ar: 'التدفق الخارجي والتحويلات الداخلية لكل خزينة خلال الفترة المحددة.', en: 'External cash flow and internal transfers for every vault.' },
  dashboardVault: { ar: 'الخزينة', en: 'Vault' },
  dashboardInflow: { ar: 'الداخل', en: 'Inflow' },
  dashboardInflowShare: { ar: 'نسبة الداخل', en: 'Inflow share' },
  dashboardOutflow: { ar: 'الخارج', en: 'Outflow' },
  dashboardTransferIn: { ar: 'تحويل داخل', en: 'Transfer in' },
  dashboardTransferOut: { ar: 'تحويل خارج', en: 'Transfer out' },
  dashboardTransferVolume: { ar: 'التحويلات الداخلية', en: 'Internal transfers' },
  dashboardPeriodResult: { ar: 'نتيجة الفترة', en: 'Period result' },
  dashboardNoVaultActivity: { ar: 'لا توجد حركة خزائن خلال الفترة المحددة.', en: 'No vault activity in the selected period.' },
  dashboardVaultActivityNote: { ar: 'الداخل والخارج يمثلان التدفق الخارجي فقط، والتحويلات الداخلية معروضة بصورة مستقلة. نتيجة الفترة ليست الرصيد التراكمي.', en: 'Inflow and outflow show external cash flow only; internal transfers are shown separately. Period result is not the cumulative balance.' },
  dashboardFixedExpensesTitle: { ar: 'التكاليف التشغيلية الدورية', en: 'Recurring operating costs' },
  dashboardFixedExpensesDesc: { ar: 'الرواتب والخدمات والرسوم الدورية ونسبتها من مبيعات الفترة.', en: 'Payroll, recurring services and fees, and their share of period sales.' },
  dashboardPeriodAmount: { ar: 'مبلغ الفترة', en: 'Period amount' },
  dashboardShareOfSales: { ar: 'نسبة من المبيعات', en: 'Share of sales' },
  dashboardFixedExpenseInvoices: { ar: 'عدد سجلات التكلفة الدورية', en: 'Recurring cost records' },
  dashboardFixedExpenseItem: { ar: 'البند', en: 'Item' },
  dashboardFixedExpenseSource: { ar: 'المصدر', en: 'Source' },
  dashboardFixedExpenseShare: { ar: 'نسبتها', en: 'Share' },
  dashboardNoFixedExpenseDetails: { ar: 'لا توجد تكاليف تشغيلية دورية في الفترة المحددة.', en: 'No recurring operating costs in the selected period.' },
  dashboardFixedExpenseDetailsLimited: { ar: 'تظهر أحدث 100 سجل فقط حفاظًا على سرعة لوحة التحكم.', en: 'Only the latest 100 records are shown to keep the dashboard fast.' },
  dashboardOperatingCostsTitle: { ar: 'إجمالي التكاليف التشغيلية', en: 'Total operating costs' },
  dashboardOperatingCostsDesc: { ar: 'المشتريات + التكاليف الدورية + المصاريف الأخرى خلال الفترة.', en: 'Purchases + recurring costs + other expenses for the period.' },
  dashboardOperatingCostKpiTitle: { ar: 'تكلفة التشغيل', en: 'Operating cost' },
  dashboardOperatingCostKpiDesc: { ar: 'مجموع الأقسام الثلاثة أدناه خلال الفترة.', en: 'The exact sum of the three cost sections below.' },
  dashboardRecurringAndOtherExpenses: { ar: 'التكاليف والمصاريف', en: 'Recurring and other expenses' },
  dashboardOperatingResultTitle: { ar: 'النتيجة التشغيلية', en: 'Operating result' },
  dashboardOperatingResultDesc: { ar: 'الإيرادات − تكلفة التشغيل.', en: 'Revenue − operating cost.' },
  dashboardGrossAfterPurchases: { ar: 'المتبقي بعد المشتريات', en: 'After purchases' },
  dashboardCashOut: { ar: 'صرف الخزائن', en: 'Vault cash paid' },
  dashboardCashCostDifference: { ar: 'فرق النقد والتكلفة', en: 'Cash/cost difference' },
  dashboardCashCostDifferenceHint: { ar: 'ينشأ من السلف والقروض وسداد مديونيات سابقة أو فواتير لم تُسدد بعد.', en: 'Caused by advances, loans, prior debt settlements, or unpaid invoices.' },
  dashboardOtherExpensesTitle: { ar: 'المصاريف الأخرى حسب الفئات', en: 'Other expenses by category' },
  dashboardOtherExpensesDesc: { ar: 'المصاريف العادية غير الدورية موزعة حسب الفئات.', en: 'Ordinary non-recurring expenses grouped by category.' },
  dashboardNoOtherExpensesByCategory: { ar: 'لا توجد مصاريف أخرى خلال الفترة المحددة.', en: 'No other expenses in the selected period.' },
  dashboardPurchasesOverviewTitle: { ar: 'المشتريات حسب الفئات', en: 'Purchases by category' },
  dashboardPurchasesOverviewDesc: { ar: 'إجمالي المشتريات ونسبتها من المبيعات، مع توزيع الفئات.', en: 'Total purchases, their share of sales, and category distribution.' },
  ...
  dashboardTimelineSalesTab: { ar: 'المبيعات', en: 'Sales' },
  dashboardTimelineCustomerTab: { ar: 'العملاء والفاتورة', en: 'Customers & ticket' },
  dashboardTimelineCustomers: { ar: 'عدد العملاء', en: 'Customers' },
  dashboardTimelineAvgInvoice: { ar: 'معدل الفاتورة', en: 'Avg ticket' },
  ...
  dashboardAppSalesChart: { ar: 'نسبة التطبيقات من المبيعات — شهري', en: 'App share of sales — monthly' },
  dashboardAppSalesYearsSpan: { ar: 'الفترة', en: 'Period' },
  dashboardAppSalesYears1: { ar: 'سنة واحدة', en: '1 year' },
  dashboardAppSalesYears2: { ar: 'سنتان', en: '2 years' },
  ...
  dashboardTargetThisMonthOnly: { ar: 'هذا الشهر فقط', en: 'This month only' },
  dashboardTargetScopeLabel: { ar: 'حفظ الهدف', en: 'Save target' },
  dashboardTargetDefault: { ar: 'الهدف الافتراضي — لكل الشهور', en: 'Default — applies to all months' },
  dashboardTargetMonthSpecific: { ar: 'مخصص لهذا الشهر', en: 'Custom for this month' },
  dashboardTargetResetToDefault: { ar: 'إعادة للافتراضي', en: 'Reset to default' },
  dashboardTargetDefaultNote: { ar: 'الأشهر الأخرى تستخدم الهدف الافتراضي العام', en: 'Other months use the global default target' },
  ...
  dashboardImportSaudiScopeTitle: { ar: 'أين تُطبَّق المناسبات؟', en: 'Apply occasions where?' },
  dashboardImportSaudiScopeCompany: { ar: 'الشركة / المنشأة الحالية فقط', en: 'Current company only' },
  dashboardImportSaudiScopeTenant: { ar: 'جميع المنشآت والشركات', en: 'All companies in organization' },
  dashboardImportSaudiScopeTenantCount: { ar: 'سيتم التطبيق على {0} شركة', en: 'Will apply to {0} companies' },
  dashboardImportSaudiSuccess: { ar: 'تم تطبيق {0} مناسبة على {1} شركة', en: 'Applied {0} occasion(s) across {1} company(ies)' },
  dashboardImportSaudiNoSelection: { ar: 'اختر مناسبة واحدة على الأقل', en: 'Select at least one occasion' },
  dashboardImportSaudiLoading: { ar: 'جاري تحميل المناسبات…', en: 'Loading occasions…' },
  dashboardImportSaudiEmptyYear: { ar: 'لا توجد مناسبات معرّفة لهذا العام بعد', en: 'No occasions defined for this year yet' },
  dashboardImportSchoolHolidays: { ar: 'استيراد إجازات المدارس', en: 'Import school holidays' },
  dashboardImportSchoolHint: {
    ar: 'تستورد فترات إجازات المدارس كمصدر مستقل عن المناسبات السعودية.',
    en: 'Imports school break periods as a source separate from Saudi occasions.',
  },
  dashboardImportSchoolVariantGeneral: { ar: 'التقويم العام', en: 'General calendar' },
  dashboardImportSchoolVariantWestern: { ar: 'مكة/المدينة/جدة/الطائف', en: 'Makkah/Madinah/Jeddah/Taif' },
  dashboardImportSchoolSource: { ar: 'المصدر: {0} — آخر تحديث {1}', en: 'Source: {0} — updated {1}' },
  dashboardImportSchoolAcademicYear: { ar: 'العام الدراسي: {0}', en: 'Academic year: {0}' },
  dashboardImportSchoolLoadFailed: { ar: 'تعذر تحميل إجازات المدارس.', en: 'Could not load school holidays.' },
  dashboardImportSchoolLoading: { ar: 'جاري تحميل إجازات المدارس…', en: 'Loading school holidays…' },
  dashboardImportSchoolEmptyYear: { ar: 'لا توجد إجازات مدارس معرفة لهذه السنة.', en: 'No school holidays are defined for this year.' },
  dashboardImportSchoolNoSelection: { ar: 'اختر إجازة واحدة على الأقل', en: 'Select at least one school holiday' },
  dashboardImportSchoolSuccess: {
    ar: 'تم تطبيق {0} إجازة مدارس على {1} شركة وتحديث {2} شهر',
    en: 'Applied {0} school holiday(s) to {1} company(ies), updating {2} month(s)',
  },
  dashboardBack: { ar: 'رجوع', en: 'Back' },
  ...
  dashboardCalendarWeekdaySalesAvg: { ar: 'متوسط المبيعات حسب يوم الأسبوع', en: 'Sales average by weekday' },
  dashboardCalendarWeekdaySalesAvgShort: { ar: 'معدل', en: 'Avg' },
  ...
  dashboardWeeklySalesPeriodCompareHeader: { ar: 'فترة المقارنة', en: 'Comparison period' },
  dashboardWeeklySalesPeriodAColumn: { ar: 'شهر العمود الأول', en: 'First column month' },
  dashboardWeeklySalesPeriodAYear: { ar: 'سنة العمود الأول', en: 'First column year' },
  dashboardWeeklySalesPeriodBColumn: { ar: 'شهر عمود المقارنة', en: 'Comparison column month' },
  dashboardWeeklySalesPeriodBYear: { ar: 'سنة عمود المقارنة', en: 'Comparison column year' },
