...
export default {
  ...
  dashboardVaultActivityDesc: { ar: 'داخل وخارج ونتيجة كل خزينة خلال الفترة المحددة.', en: 'Inflow, outflow, and period result for every vault.' },
  ...
  dashboardVaultActivityNote: { ar: 'نتيجة الفترة = الداخل − الخارج. تشمل الأرقام جميع الحركات المرحلة، وليست الرصيد التراكمي للخزينة.', en: 'Period result = inflow − outflow. Figures include all posted movements and are not the cumulative vault balance.' },
