...
export default {
  ...
  backupSystemIntro: {
    ar: 'للمالك أو مدير النظام فقط. يُحتفظ بآخر عدد محدد من النسخ؛ الأقدم تُحذف تلقائياً. يتطلب pg_dump وpg_restore على الخادم.',
    en: 'Owner or super admin only. Keeps the last N copies; older ones are removed automatically. Requires pg_dump and pg_restore on the server.',
  },
