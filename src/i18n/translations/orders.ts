...
export default {
  ...
  salesProducts: { ar: 'أصناف المبيعات', en: 'Sales Products' },
  ...
  importReasonMissingSection: { ar: 'حدّد قسم مبيعات واحد على الأقل (من الشاشة أو عمود sections)', en: 'Pick at least one sales section (in UI or sections column)' },
  importChooseSections: { ar: 'قسم المبيعات للاستيراد', en: 'Sales section for import' },
  ...
  importSectionsRequired: { ar: 'اختر قسم مبيعات واحداً على الأقل قبل رفع الملف.', en: 'Select at least one sales section before uploading the file.' },
  ...
  staffSaleSubmit:          { ar: 'إرسال المبيعات (واتساب)', en: 'Send sales (WhatsApp)' },
  staffSaleBasket:          { ar: 'المبيعات', en: 'Sales' },
  staffSaleDate:            { ar: 'يوم المبيعات', en: 'Sales day' },
  staffSaleDateRequired:    { ar: 'اختر يوم المبيعات', en: 'Select the sales day' },
  staffSaleCreated:         { ar: 'تم تسجيل المبيعات وفتح واتساب', en: 'Sales recorded and WhatsApp opened' },
  staffSaleUpdated:         { ar: 'تم تحديث المبيعات وفتح واتساب', en: 'Sales updated and WhatsApp opened' },
  staffSaleResent:          { ar: 'تم فتح واتساب', en: 'WhatsApp opened' },
  staffSaleUpdate:          { ar: 'تحديث وإرسال (واتساب)', en: 'Update & send (WhatsApp)' },
  staffSaleResend:          { ar: 'إعادة واتساب', en: 'Resend WhatsApp' },
  staffSaleDeleteConfirm:   { ar: 'هل تريد حذف هذه المبيعات؟', en: 'Delete this sales record?' },
  staffSaleMySent:          { ar: 'مبيعاتي المُرسلة', en: 'My sent sales' },
  staffSaleNoRecords:       { ar: 'لا توجد مبيعات بعد. سجّل مبيعاتك أعلاه.', en: 'No sales yet. Record sales above.' },
  ...
  salesReportTab:           { ar: 'تقارير المبيعات', en: 'Sales Reports' },
  salesReportTabShort:      { ar: 'مبيعات', en: 'Sales' },
  ...
  salesReportEmpty:         { ar: 'لا توجد مبيعات في هذه الفترة', en: 'No sales in this period' },
