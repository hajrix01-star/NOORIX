...
export default {
  ...
  dayCloseWaTitle: { ar: '📋 تقرير نهاية اليوم', en: '📋 End-of-day report' },
  dayCloseWaDateLine: { ar: '📅 التاريخ:', en: '📅 Date:' },
  dayCloseWaSectionSummary: { ar: 'ملخص المؤشرات', en: 'Key figures' },
  dayCloseWaInflowLine: { ar: '📥 الوارد (مبيعات):', en: '📥 Inflow (sales):' },
  dayCloseWaOutflowLine: { ar: '📤 الصادر:', en: '📤 Outflow:' },
  dayCloseWaNetCashLine: { ar: '💵 صافي حركة الكاش اليوم:', en: '💵 Net cash movement (day):' },
  dayCloseWaAvailableCashLine: { ar: '🏦 الكاش المتوفر:', en: '🏦 Available cash:' },
  dayCloseWaCashMoveLine: { ar: '↕️ حركة الكاش:', en: '↕️ Cash movement:' },
  dayCloseWaTransfersLine: { ar: '🔄 تحويلات بين خزائن:', en: '🔄 Inter-vault transfers:' },
  dayCloseWaOpsMore: {
    ar: '… و{0} عملية إجمالاً (عرض {1} في الرسالة)',
    en: '… {0} operations total ({1} shown in this message)',
  },
