...
export default {
  ...
  ocrViewProgress:     { ar: 'عرض التقدم', en: 'View progress' },
  ocrQueueWaiting:     { ar: 'في انتظار بدء الاستخراج…', en: 'Waiting to start extraction…' },
  ocrReviewProgressSheetTitle: { ar: 'متابعة عملية OCR', en: 'OCR operation progress' },
