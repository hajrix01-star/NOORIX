  ...
  return buildPrintDocumentHtml({
    ...
    body: buildPrintTableHtml({
      ...
      rows: activeInvoices.map((invoice, index) => ({
        ...
        net: `${fmt(toPurchaseBatchFiniteNumber(invoice.netAmount))} SR`,
        tax: `${fmt(toPurchaseBatchFiniteNumber(invoice.taxAmount))} SR`,
        total: `${fmt(toPurchaseBatchFiniteNumber(invoice.totalAmount))} SR`,
