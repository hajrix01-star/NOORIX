    ...
    >
      ...
      <div className={`noorix-summary-bar noorix-summary-bar--${vatEnabled && totalAmount.gt(0) ? '5' : '3'} mb-2`}>
        <div className="noorix-summary-bar__item">
          ...
          <div className="noorix-summary-bar__value noorix-summary-bar__value--green">{fmt(totalAmount, 2)} <span className="nx-sar">SA</span></div>
        </div>
        {vatEnabled && totalAmount.gt(0) && (
          <>
            <div className="noorix-summary-bar__item">
              <div className="noorix-summary-bar__label">الصافي</div>
              <div className="noorix-summary-bar__value noorix-summary-bar__value--blue">{fmt(totalNet, 2)} <span className="nx-sar">SA</span></div>
            </div>
            <div className="noorix-summary-bar__item">
              <div className="noorix-summary-bar__label">الضريبة</div>
              <div className="noorix-summary-bar__value noorix-summary-bar__value--amber">{fmt(totalTax, 2)} <span className="nx-sar">SA</span></div>
            </div>
          </>
        )}
        <div className="noorix-summary-bar__item">
        ...
        <div className="noorix-summary-bar__item">
          ...
          <div className="noorix-summary-bar__value">{fmt(avgPerCustomer, 2)} <span className="nx-sar">SA</span></div>
        </div>
      </div>
    </AdaptiveSheet>
  );
