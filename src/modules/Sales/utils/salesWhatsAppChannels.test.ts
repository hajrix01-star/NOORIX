...
describe('salesWhatsAppChannels', () => {
  const vaultById = buildVaultLookup([
    { id: 'v1', nameAr: 'نقدي', sortOrder: 1 },
    { id: 'v2', nameAr: 'بنك', sortOrder: 2 },
  ]);
      ...
      [
        {
          ...
          shift: 'morning',
          channels: [
            { vaultId: 'v1', amount: 100, vault: { nameAr: 'نقدي', sortOrder: 1 } },
            { vaultId: 'v2', amount: 50, vault: { nameAr: 'بنك', sortOrder: 2 } },
          ],
        },
        {
          status: 'active',
