...
export function OrdersV4CatalogReferences({
  ...
  return <>
    ...
    {tab === 'units' && <div className="flex flex-col gap-4"><OrdersV4Panel title="وحدات وتغليف المطاعم" action={<Button variant="primary" size="sm" onClick={() => openCreate('unit')}>+ إضافة وحدة</Button>}><p className="mb-3 text-[12px] text-noorix-muted">مصدر واحد للوحدات المستخدمة في الأصناف والرسبي والتحويلات.</p><SimpleTable columns={[
