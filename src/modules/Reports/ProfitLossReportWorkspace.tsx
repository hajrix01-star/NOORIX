...
import { ProfitLossPeriodSelector, buildProfitLossPeriodLabel } from './ProfitLossPeriodSelector';
...
export default function ProfitLossReportWorkspace({
  ...
  const periodLabel = buildProfitLossPeriodLabel({
    isArabic,
    monthNames,
    periodMode,
    selectedMonthPeriods,
    ...
    <div className="nx-pl-workspace">
      <section className="nx-pl-command-center" aria-labelledby="general-pl-title">
        ...
        <ProfitLossPeriodSelector
          ...
          t={t}
          onApplyPeriodSelection={onApplyPeriodSelection}
        />
      </section>
