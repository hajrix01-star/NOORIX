...
<div style="text-align:center;border-bottom:2px solid #333;padding-bottom:16px;margin-bottom:24px"><h1 style="margin:0;font-size:20px">سجل مدفوعات - ${(line?.nameAr || line?.nameEn || '—').replace(/</g, '&lt;')}</h1><p style="margin:8px 0 0;font-size:12px;color:#555">إجمالي: ${fmt(totalPaid)} SR</p></div>
