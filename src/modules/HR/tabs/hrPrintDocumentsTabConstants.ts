...
.hr-sheet.gen-print{--doc-primary:#147044;--doc-primary-soft:#e8f3ed;--doc-accent:#9a6700;--doc-ink:#252018;--doc-muted:#6f665b;--doc-light:#f6f1e8;--doc-gray:#fbfaf7;--doc-border:#e4d9c7;--gen-amt:#147044}
.hr-sheet.gen-print{font-family:'Noto Sans Arabic','IBM Plex Sans',Tahoma,sans-serif}
.hr-sheet .legal-ref{font-size:6.3pt;line-height:1.35;color:#8a8175;text-align:center;padding:5px 8px 8px;border-bottom:1px solid #eadfce;margin:0}
.hr-sheet .legal-ref-en{margin-top:2px;font-size:5.9pt;color:#9a9082}
.hr-sheet.gen-print .document{width:100%;max-width:210mm;margin:0 auto;background:#fff;border-radius:6px;direction:rtl;color:var(--doc-ink);display:flex;flex-direction:column;box-sizing:border-box;overflow:hidden;border:1px solid var(--doc-border);box-shadow:0 12px 30px rgba(60,45,25,.08)}
.hr-sheet.gen-print .doc-header{background:#fff;padding:18px 22px 16px;display:flex;align-items:center;justify-content:space-between;gap:18px;border-top:5px solid var(--doc-primary);border-bottom:1px solid var(--doc-border)}
.hr-sheet.gen-print .doc-header-logo{width:68px;height:68px;background:var(--doc-gray);border:1px solid var(--doc-border);border-radius:10px;display:flex;align-items:center;justify-content:center;overflow:hidden;flex-shrink:0;padding:5px}
.hr-sheet.gen-print .doc-header-logo img{max-width:100%;max-height:100%;object-fit:contain}
.hr-sheet.gen-print .gen-logo-placeholder{font-size:10px;color:#9a9082;text-align:center;line-height:1.35}
.hr-sheet.gen-print .doc-header-center{flex:1;text-align:center;min-width:0}
.hr-sheet.gen-print .doc-company-ar{font-size:18px;font-weight:800;color:var(--doc-primary);font-family:'Noto Sans Arabic',sans-serif;line-height:1.2}
.hr-sheet.gen-print .doc-company-en{font-size:12px;color:var(--doc-muted);margin-top:4px;font-weight:600}
.hr-sheet.gen-print .doc-divider{border:none;border-top:1px solid var(--doc-border);margin:9px auto;width:70%;max-width:260px}
.hr-sheet.gen-print .doc-title-ar{font-size:17px;font-weight:800;color:var(--doc-ink);font-family:'Noto Sans Arabic',sans-serif;line-height:1.25;margin-top:2px}
.hr-sheet.gen-print .doc-title-en{font-size:11px;color:var(--doc-muted);margin-top:4px;font-weight:600}
.hr-sheet.gen-print .doc-header-sub{font-size:10px;color:var(--doc-accent);margin-top:6px;font-weight:700}
.hr-sheet.gen-print .doc-header-sub-en{font-size:10px;color:var(--doc-muted);margin-top:2px}
.hr-sheet.gen-print .doc-header-space{width:68px;flex-shrink:0}
.hr-sheet.gen-print .doc-body{padding:18px 22px 12px;flex:1}
.hr-sheet.gen-print .doc-section-title{background:transparent;color:var(--doc-ink);font-size:12px;font-weight:800;padding:0 0 7px;border-bottom:1px solid var(--doc-border);margin:0 0 10px;display:flex;align-items:center;justify-content:space-between;gap:10px}
.hr-sheet.gen-print .doc-section-title span:first-child{position:relative;padding-inline-start:10px}
.hr-sheet.gen-print .doc-section-title span:first-child::before{content:"";position:absolute;inset-inline-start:0;top:.25em;width:3px;height:1.1em;border-radius:999px;background:var(--doc-primary)}
.hr-sheet.gen-print .doc-section-title-en{font-size:10px;font-weight:700;color:var(--doc-muted);opacity:.95}
...
.hr-sheet.gen-print .doc-info-label{font-size:10px;color:var(--doc-muted);font-weight:700;white-space:nowrap;min-width:72px}
.hr-sheet.gen-print .doc-info-value{font-size:12px;color:var(--doc-ink);font-weight:800;flex:1;word-break:break-word}
...
.hr-sheet.gen-print .doc-emp-lbl{font-size:10px;color:var(--doc-muted);font-weight:700}
.hr-sheet.gen-print .doc-emp-val{font-size:12px;color:var(--doc-ink);font-weight:800}
.hr-sheet.gen-print .doc-declaration{background:var(--doc-gray);border:1px solid var(--doc-border);border-inline-start:4px solid var(--doc-primary);border-radius:6px;padding:14px 16px;margin-bottom:16px}
.hr-sheet.gen-print .doc-declaration p{font-size:11.5px;line-height:1.85;color:var(--doc-ink);margin:0 0 10px;text-align:justify}
.hr-sheet.gen-print .doc-declaration p:last-child{margin-bottom:0}
.hr-sheet.gen-print .doc-declaration .dec-en{direction:ltr;text-align:justify;color:#51483e;font-size:11px}
...
.hr-sheet.gen-print .doc-decl-lang-lbl{font-size:10px;font-weight:800;color:var(--doc-muted);margin:0 0 6px;display:flex;align-items:baseline;justify-content:space-between;gap:8px;flex-wrap:wrap}
.hr-sheet.gen-print .doc-decl-lang-lbl-en{font-size:9px;font-weight:600;color:#9a9082}
.hr-sheet.gen-print .doc-decl-lang-body{margin:0;font-size:11.5px;line-height:1.8;color:var(--doc-ink);text-align:justify;white-space:pre-wrap}
.hr-sheet.gen-print .doc-decl-lang-body--en{color:#51483e;font-size:11px}
...
.hr-sheet.gen-print .doc-sig-header{background:var(--doc-primary-soft);padding:8px 12px;text-align:center}
.hr-sheet.gen-print .doc-sig-title-ar{font-size:12px;font-weight:700;color:var(--doc-primary)}
.hr-sheet.gen-print .doc-sig-title-en{font-size:10px;color:var(--doc-muted);margin-top:2px}
.hr-sheet.gen-print .doc-sig-space{height:64px}
.hr-sheet.gen-print .doc-sig-footer{background:var(--doc-gray);border-top:1px solid var(--doc-border);padding:8px 12px;font-size:10px;color:var(--doc-muted);text-align:center}
.hr-sheet.gen-print .doc-sig-footer strong{display:block;font-size:11px;color:var(--doc-primary);font-weight:800;margin-bottom:4px}
.hr-sheet.gen-print .doc-footer{background:var(--doc-gray);margin-top:auto;padding:9px 22px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;border-top:1px solid var(--doc-border)}
.hr-sheet.gen-print .doc-footer-text{font-size:10px;color:var(--doc-muted);max-width:72%}
.hr-sheet.gen-print .doc-footer-date{font-size:10px;color:var(--doc-muted)}
...
.hr-sheet.gen-print .pr-table thead th{background:var(--doc-light);color:var(--doc-ink);font-weight:800}
.hr-sheet.gen-print .pr-table tbody td:first-child{text-align:right;font-weight:700;color:var(--doc-ink)}
.hr-sheet.gen-print .pr-table .cell-amt{color:var(--gen-amt);font-weight:800}
.hr-sheet.gen-print .pr-table .cell-sig{color:#9a9082;font-family:monospace;font-size:9px;letter-spacing:.5px}
.hr-sheet.gen-print .pr-table tfoot td{background:var(--doc-primary-soft);font-weight:800}
...
.hr-sheet.gen-print .doc-table thead th{background:var(--doc-light);color:var(--doc-ink);font-weight:800}
...
.hr-sheet.gen-print .doc-note{white-space:pre-wrap;font-size:10px;line-height:1.45;color:#51483e;margin-top:8px;padding:8px;background:var(--doc-gray);border:1px dashed var(--doc-border);border-radius:4px}
...
@media print{
  ...
  .hr-sheet.gen-print .doc-header{padding:8px 12px 8px!important;gap:10px!important;border-top-width:4px!important}
  .hr-sheet.gen-print .doc-header-logo{width:50px!important;height:50px!important;padding:2px!important}
  .hr-sheet.gen-print .doc-header-space{width:50px!important}
  ...
  .hr-sheet.gen-print .doc-section-title{font-size:9.5pt!important;padding:0 0 5px!important;margin:0 0 6px!important;border-radius:0!important}
  ...
  .hr-sheet.gen-print .doc-declaration{padding:8px 10px!important;margin-bottom:8px!important;border-inline-start-width:3px!important}
  ...
  .hr-sheet.gen-print .doc-footer{padding:6px 12px!important;flex-wrap:nowrap!important}
