...
export function InvoiceEditModal({ invoice, suppliers, companyId, vaultsList = [], onSaved, onClose }: any) {
  ...
  const supplierRequired = !NO_SUPPLIER_KINDS.has(kind) && !OPTIONAL_SUPPLIER_KINDS.has(kind); // purchase, expense ›ﬁÿ
      ...
      <div className="invoice-edit-modal-body flex flex flex-col gap-3.5">
        ...
        <div>
          <Input
            ...
            min="0.01"
            step="0.01"
            label={t('totalAmountInclTax') || '«·≈Ã„«·Ì (‘«„· «·÷—Ì»…) *'}
