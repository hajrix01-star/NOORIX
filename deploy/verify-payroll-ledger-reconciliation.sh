...
# The query reports every discrepancy, by company and run, without changing
# invoices, employee advances, vaults, or ledger rows.
...
WHERE ABS(paid.expected_cost - COALESCE(actuals.actual_cost, 0)) > 0.01
