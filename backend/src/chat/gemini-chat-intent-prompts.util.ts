...
- purchases: مشتريات كأرقام تشغيلية، كم اشترينا (كمية/مبلغ مشتريات)، إجمالي المشتريات للفترة — بدون طلب تقييم أو «صحة مالية» أو تحليل تنبيهات
- expenses: مصروفات، مصاريف، كم صرفنا كأرقام — بدون طلب تقييم لوحة أو تنبيهات
...
- dashboard_insights: تقييم الصحة المالية، صحة الأعمال، ملخص رؤى، تنبيهات، كيف وضع الشهر، وضع الشهر، ملخص الشهر، اعطني ملخص الشهر، كيف الأداء المالي، حلل المشتريات، حلل المصاريف، تحليل المشتريات، تحليل المصاريف، purchase analysis، expense analysis، financial health، business health، هل المشتريات مرتفعة، هل الربح جيد، monthly summary، how is the month، are purchases high، is profit good — أسئلة تقييم/ملخص رؤى لوحة التحكم وليست تقرير P&L ولا سؤال «كم مبيعاتنا» أو «كم مشترياتنا» كرقم تشغيلي فقط بدون سياق تقييم
...
قواعد تمييز سريعة:
- إذا ظهرت كلمات مثل: وضع، صحة، تنبيهات، ملخص مالي، تقييم، أداء، رؤى — فاغلب أنها dashboard_insights وليست purchases/expenses كرقم فقط.
- إذا السؤال صريح عن «كم» مبيعات/مشتريات/مصروفات للفترة بدون تقييم — sales أو purchases أو expenses حسب السياق.
- إذا غير متأكد بين intentين، اختر الأقرب واضبط confidence منخفضاً (أقل من 0.55) أو استخدم unknown.
...
الصيغة: {"intent":"...","period":"..." أو null,"confidence":0.0 إلى 1.0}
- confidence: رقم بين 0 و 1 (مطلوب عندما تستطيع): ثقتك في اختيار intent. استخدم قيمة منخفضة عند الالتباس.
