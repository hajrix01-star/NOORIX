...
import type {
  ...
  OrdersV3InventoryCalculation,
  OrdersV3LineCalculation,
...
export function calculateOrdersV3Line(input: {
...
export function calculateOrdersV3Receipt(
  balance: OrdersV3InventoryBalance,
...
export function calculateOrdersV3Issue(
  balance: OrdersV3InventoryBalance,
...
export function calculateOrdersV3StocktakeAdjustment(
  balance: OrdersV3InventoryBalance,
