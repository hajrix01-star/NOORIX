...
export const PERMISSION_MODULES: PermissionModule[] = [
  ...
  {
    key: 'ordersV3', labelAr: 'طلبات 2 — النواة V3', labelEn: 'Orders 2 — V3 Core', icon: '🧬',
    permissions: {
      view: 'VIEW_ORDERS_V3',
      read: 'ORDERS_V3_READ',
      write: 'ORDERS_V3_WRITE',
      delete: 'ORDERS_V3_DELETE',
      staffSubmit: 'ORDERS_V3_STAFF_SUBMIT',
      internalSubmit: 'ORDERS_V3_INTERNAL_SUBMIT',
      reports: 'ORDERS_V3_REPORTS_READ',
      inventory: 'ORDERS_V3_INVENTORY_WRITE',
    },
  },
  {
...
export const PERMISSION_LEVELS: Record<string, { ar: string; en: string }> = {
  ...
  reports: { ar: 'قراءة تقارير V3', en: 'Read V3 reports' },
  inventory: { ar: 'إدارة مخزون وجرد V3', en: 'Manage V3 inventory and stocktakes' },
...
export const SYSTEM_ROLE_SEEDS: Record<string, { nameAr: string; permissions: string[] }> = {
  ...
  [ROLES.ACCOUNTANT]:  {
    ...
    permissions: [
      ...
      PERMISSIONS.VIEW_ORDERS_V3, PERMISSIONS.ORDERS_V3_READ, PERMISSIONS.ORDERS_V3_WRITE,
      PERMISSIONS.ORDERS_V3_REPORTS_READ, PERMISSIONS.ORDERS_V3_INVENTORY_WRITE,
