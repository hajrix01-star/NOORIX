...
@Module({
  ...
  providers: [OrdersV4CatalogService, OrdersV4DocumentReversalService, OrdersV4DocumentsService, OrdersV4FundsPostingService, OrdersV4InventoryService, OrdersV4ItemDefinitionService, OrdersV4LedgerPostingService, OrdersV4PurchaseCorrectionService, OrdersV4ReportsService],
