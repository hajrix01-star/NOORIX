...
@Module({
  ...
  providers: [OrdersV4CatalogService, OrdersV4DocumentsService, OrdersV4FundsPostingService, OrdersV4InventoryService, OrdersV4ItemDefinitionService, OrdersV4LedgerPostingService, OrdersV4LegacyCutoverService, OrdersV4ReportsService],
