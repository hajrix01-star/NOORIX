...
const requiredContracts = [
  ...
  ['backend/src/sales/sales.service.ts', 'dailyTotals: dailyTotalRows'],
  ['backend/src/sales/sales.service.ts', 'dailyWeeklyComparison: weeklyComparisonRows'],
  ['backend/src/sales/sales.service.ts', 'shiftTotals: salesShiftTotals'],
  ['backend/src/sales/sales.service.ts', 'channelBreakdown: channelBreakdown'],
  ['backend/src/sales/sales.service.ts', 'appSales: appSalesModel'],
