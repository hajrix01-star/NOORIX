...
|---------|---------|--------|-------------------------|--------|---------------------|---------|
| 2026-04-26 | D | D (OCR: useInvoiceUploadTab) | (hash بعد الدمج) | Cursor | ✓ | `useInvoiceUploadTab.js` يضم الاستعلامات والتأثيرات والتعامل مع الاستخراج/الحفظ؛ `InvoiceUploadTab.jsx` ≈100 سطر (عرض فقط). **التحقق:** vitest + vite build |
